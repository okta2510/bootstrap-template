...
function ta_daily_blog_scripts() {
	wp_enqueue_style( 'bootstrap-styles', get_template_directory_uri() . '/css/'. ta_option('css_style', 'lumen.css'), array(), '3.3.1', 'all' );
	...
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery'), '3.2.1', true );
