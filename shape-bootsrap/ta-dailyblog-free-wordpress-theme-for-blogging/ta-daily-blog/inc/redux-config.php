<?php
    ...
    if ( ! class_exists( 'Redux_Framework_ta_config' ) ) {
        ...
        class Redux_Framework_ta_config {
            ...
            // Remove the demo link and the notice of integrated demo from the ta-dailyblog plugin
                ...
                $this->sections[] = array(
                    ...
                    'fields'    => array(
                        array( 
                            ...
                            'subtitle'  => __( 'Add your own custom text/html for copyright region.', 'ta-dailyblog' ),
                            'id'        => 'custom_copyright',
                            'default'   => 'Copyright 2014 - <a href="http://themeart.co/free-theme/ta-dailyblog/" title="TA DailyBlog Free WordPress Theme" target="_blank">TA DailyBlog</a>.',
                            'type'      => 'editor',
                        ),

                        array( 
                            'title'     => __( 'Custom Powered By Text', 'ta-dailyblog' ),
                            'subtitle'  => __( 'Add your own custom text/html for powered by region.', 'ta-dailyblog' ),
                            'id'        => 'custom_powerby',
                            'default'   => 'Powered by <a href="http://themeart.co/" title="Downlod Free Premium WordPress Themes &amp; Templates" target="_blank">ThemeArt</a> and <a href="http://wordpress.org/" title="Blog Tool, Publishing Platform, and CMS" target="_blank">WordPress</a>.',
                            'type'      => 'editor',
                        ),
                    )
                );
            ...
            public function setHelpTabs() {
                ...
                $this->args['help_tabs'][] = array(
                    'id'      => 'redux-help-tab-1',
                    'title'   => __( 'Theme Information 1', 'ta-dailyblog' ),
                    'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'ta-dailyblog' )
                );

                $this->args['help_tabs'][] = array(
                    'id'      => 'redux-help-tab-2',
                    'title'   => __( 'Theme Information 2', 'ta-dailyblog' ),
                    'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'ta-dailyblog' )
                );

                // Set the help sidebar
                $this->args['help_sidebar'] = __( '<p>This is the sidebar content, HTML is allowed.</p>', 'ta-dailyblog' );
            }
