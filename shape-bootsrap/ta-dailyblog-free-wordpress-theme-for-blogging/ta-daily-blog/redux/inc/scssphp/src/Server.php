...
class Server
{
    ...
    protected function needsCompile($in, $out, &$etag)
    {
        ...
        if (is_readable($metadataName)) {
            $metadata = unserialize(WP_Filesystem($metadataName));
    ...
    protected function compile($in, $out)
    {
        ...
        $css     = $this->scss->compile(WP_Filesystem($in), $in);
    ...
    public function compileFile($in, $out = null)
    {
        ...
        $compiled = $this->scss->compile(WP_Filesystem($in), $in);

        if ($out !== null) {
            return WP_Filesystem($out, $compiled);
        }
