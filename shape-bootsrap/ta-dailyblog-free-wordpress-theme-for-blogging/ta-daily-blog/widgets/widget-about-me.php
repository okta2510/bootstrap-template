...
class ta_dailyblog_about_me_widget extends WP_Widget {
	/* Object variables */
	...
	/* Constructor method */
	function ta_dailyblog_about_me_widget() {
		$widget_ops = array( 'classname' => 'about-me-widget', 'description' => __( "Add about me widget to your sidebar." , 'ta-dailyblog' ) );
		$this->WP_Widget( 'ta_dailyblog_about_me_widget', __( 'TA DailyBlog: About Me Widget', 'ta-dailyblog' ), $widget_ops );
    }
	...
	function form( $instance ) {
		...
		<p><strong><?php _e( 'Select the author this widget is about:', 'ta-dailyblog' ); ?></strong><br />
		...
		<p><strong><?php _e( 'Title:', 'ta-dailyblog' ); ?></strong><br />
			<input class="widefat" type="text" 
				id="<?php echo $this->get_field_id( 'title' ); ?>" 
				name="<?php echo $this->get_field_name( 'title' ); ?>" 
				value="<?php echo $title; ?>"/>
			<br /><?php _e( 'Leave blank for default - "About Me."', 'ta-dailyblog' ); ?>
		</p>
		
		<p><strong><?php _e( 'Mugshot', 'ta-dailyblog' ); ?></strong>
			<br /><?php _e( 'To get your profile picture to show up automatically, <a href="http://en.gravatar.com/">get a Gravatar</a>.', 'ta-dailyblog' ); ?><br />
		</p>

		<p><strong><?php _e( 'Bio', 'ta-dailyblog' ); ?></strong>
			<br /><?php _e( 'Go edit', 'ta-dailyblog' ); ?> <a href="<?php echo admin_url('profile.php'); ?>"><?php _e( 'your Profile', 'ta-dailyblog' ); ?></a> <?php _e( '"Biogaphical Info" to change the text of this bio.', 'ta-dailyblog' ); ?>
		</p>
...
}// end ta_dailyblog_about_me_widget
